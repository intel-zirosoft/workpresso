    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <aside className="w-[280px] bg-background/60 border-r border-background/60 flex flex-col p-8 shrink-0">
          <div className="mb-12">
            <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-primary mb-1">
              Steps
            </h2>
            <p className="text-[13px] text-text-muted font-medium tracking-tight">
              Document Progress
            </p>
          </div>
              ...
              <div className="max-w-5xl mx-auto">
                <header className="mb-12">
                  ...
                  <p className="text-[15px] font-medium text-text-muted leading-relaxed max-w-2xl">
                    {currentStep === "template"
                      ? "작성하시려는 문서의 성격에 가장 적합한 양식을 골라주세요."
                      : currentStep === "content"
                        ? "Markdown 형식을 지원하며 실시간 미리보기를 통해 확인하실 수 있습니다."
                ...
                {currentStep === "template" ? (
                  <div className="grid gap-8 xl:grid-cols-2">
                    {documentTemplateOptions.map((template) => {
                      ...
                      const TemplateIcon =
                        TEMPLATE_ICONS[template.id] || FileText;
                        ...
                        >
                            ...
                            <div
                              className={cn(
                                ...
                                isSelected
                                  ...
                                  : "border-background bg-surface group-hover:border-primary/40",
                              )}
                            >
                              {isSelected && (
                                <Check
                          ...
                          >
                            <div className="space-y-4">
                              ...
                              <div className="space-y-2 px-0.5">
                                {template.id === "general" && (
                                  <>
                                    <div className="flex items-center gap-2 text-[12.5px] opacity-80">
                                      -{" "}
                                      <span className="text-primary font-bold">
                                        제목:
                                      </span>{" "}
                                      <span className="bg-background h-3 w-16 rounded-sm" />
                                    </div>
                                    <div className="flex items-center gap-2 text-[12.5px] opacity-80">
                                      -{" "}
                                      <span className="text-primary font-bold">
                                      ...
                                      <span className="bg-background h-3 w-32 rounded-sm" />
                                    </div>
                                  </>
                                )}
                                {template.id === "expense" && (
                                ...
                                {template.id === "leave" && (
                                  <>
                                    ...
                                    <div className="flex items-center gap-2 text-[12.5px] opacity-80">
                                      ...
                                      <span className="bg-background h-3 w-40 rounded-sm" />
                                    </div>
                                  </>
                                )}
                                {template.id === "skip" && (
                          ...
                          {isSelected && (
                            <div className="absolute top-3 right-14 flex items-center gap-1.5 bg-primary px-3 py-1 rounded-full shadow-lg scale-90 animate-in zoom-in-50">
                              <span className="text-[9px] font-black text-primary-foreground tracking-widest">
                                SELECTED
                              </span>
                            </div>
                          )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative group">
                        ...
                        <div className="absolute bottom-4 right-6 text-[11px] font-black text-text/30 tracking-wider">
                          {editorState.content.length.toLocaleString()} /{" "}
                  ...
                  <div className="grid gap-8 xl:grid-cols-[1fr_0.8fr]">
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="rounded-lg border-background font-bold"
                      ...
                      <div className="space-y-3">
                        {editorState.approvalSteps.map((step, index) => (
                          <div
                            key={step.localId}
                            className="group relative flex items-center gap-4 bg-background/70 p-4 rounded-2xl border border-background/60 transition-all hover:bg-surface hover:shadow-md hover:border-primary/20"
                          >
                            ...
                            <div className="flex-1 space-y-1">
                              ...
                              />
                              <select
                                className="w-full bg-background text-sm text-text-muted outline-none appearance-none cursor-pointer"
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              className="rounded-full h-8 w-8 text-text/30 hover:text-destructive opacity-0 group-hover:opacity-100 transition-opacity"
                              onClick={() => onRemoveApprovalStep(step.localId)}
                              disabled={editorState.approvalSteps.length === 1}
                            >
                              <X className="h-4 w-4" />
                            </Button>
                          </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-background/50 rounded-2xl border border-background/60 p-6 flex flex-wrap gap-2">
                        {availableUsers.map((user) => {
                          const isSelected =
                            editorState.ccRecipientIds.includes(user.id);
                          return (
                            <button
                              key={user.id}
                              type="button"
                              ...
                              className={cn(
                                ...
                                isSelected
                                  ...
                                  : "bg-surface text-text-muted border border-background/60 hover:border-primary/30",
                              )}
                            >
                ...
                <div className="border-b border-background/60 px-6 py-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={onToggleExpandedContentView}
                    >
                      <Minimize2 className="h-4 w-4 mr-2" /> 기본 보기
                    </Button>
                  </div>
                </div>

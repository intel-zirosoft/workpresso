    ...
    <div className="flex flex-col h-[calc(100vh-10rem)] md:h-[calc(100vh-12rem)] max-w-4xl mx-auto space-y-4 md:space-y-6">
      <div className="flex items-center justify-between px-2">
        <div>
          ...
          <p className="text-text-muted font-body mt-1 text-xs md:text-base">
            ...
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-6 opacity-70">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-body text-xs md:text-sm text-text-muted max-w-[250px] md:max-w-xs mx-auto">
        ...
        >
          <div className="relative flex items-center bg-white rounded-pill shadow-soft p-1 border-2 border-transparent focus-within:border-primary/20">
            <Input
              ...
              className="flex-1 h-12 md:h-14 pl-5 md:pl-8 pr-14 md:pr-16 border-none shadow-none bg-transparent font-body text-sm md:text-base text-text placeholder:text-text-muted focus-visible:ring-0"
            />
            <Button 
              type="submit" 

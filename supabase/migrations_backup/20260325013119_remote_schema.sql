...
CREATE TABLE IF NOT EXISTS "public"."workspace_extensions" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "ext_name" character varying NOT NULL,
...
ALTER TABLE "public"."workspace_extensions" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."workspace_extensions"
    ADD CONSTRAINT "workspace_extensions_ext_name_key" UNIQUE ("ext_name");



ALTER TABLE ONLY "public"."workspace_extensions"
    ADD CONSTRAINT "workspace_extensions_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_knowledge_vectors_embedding" ON "public"."knowledge_vectors" USING "hnsw" ("embedding" "public"."vector_cosine_ops");
...
CREATE OR REPLACE TRIGGER "set_updated_at" BEFORE UPDATE ON "public"."meeting_logs" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "set_updated_at" BEFORE UPDATE ON "public"."workspace_extensions" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."meeting_logs"
    ADD CONSTRAINT "meeting_logs_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id");
...
GRANT ALL ON TABLE "public"."workspace_extensions" TO "anon";
GRANT ALL ON TABLE "public"."workspace_extensions" TO "authenticated";
GRANT ALL ON TABLE "public"."workspace_extensions" TO "service_role";
